...
//Main class
    public static void main(String [] args) {
        ...
        do {
            ...
            if(choice == 1) {
                accounts[AccountNum++] = createAccount(keyboard);
            } else if(choice == 2) {
                doDeposit(accounts, AccountNum, keyboard);
            } else if(choice == 3) {
                doWithdraw(accounts, AccountNum, keyboard);
            } else if(choice == 4) {
                applyInterest(accounts, AccountNum, keyboard);
            } else {
    ...
    public static void doDeposit(Account accounts [], int count, Scanner keyboard) {
        ...
        if(index >= 0) {
            ...
            System.out.println("Please note that No account exist with this  AccountNumber: " + accountNumber);
        }
    }
